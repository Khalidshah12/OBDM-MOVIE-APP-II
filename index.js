...
function display(data) {
    ...
    if (data != undefined) {
        ...
        data.forEach(function (elem) {
            ...
            posterImage.setAttribute("id", "posterImage")
...
function dataUndefined(data) {
    ...
    if (data == undefined) {
        ...
        errorimage.src = "https://cdn.dribbble.com/users/898770/screenshots/3744292/search-bar.gif"
